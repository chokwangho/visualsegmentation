...
Element.Methods = {
  ...
  cumulativeScrollOffset: function(element) {
	...
	// applied fix from http://dev.rubyonrails.org/ticket/11473
  ...
  // added centering (idea from http://lists.rubyonrails.org/pipermail/rails-spinoffs/2006-February/002311.html)
  centerInViewport: function(element){
        ...
        if(options.update){
            Event.observe(window, 'resize', function(evt) { element.centerInViewport(); }, false);
            Event.observe(window, 'scroll', function(evt) { element.centerInViewport(); }, false);
        }
		return element;
    }
